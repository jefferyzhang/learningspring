 ...
 */
public abstract class AbstractPoolingTargetSource extends AbstractPrototypeTargetSource implements PoolingConfig {
    ...
    public final void setBeanFactory(BeanFactory beanFactory) throws BeansException {
        ...
        try {
            ...
            throw new RuntimeException("Could not create instance pool", ex);
        }
    }
